...
export async function generateSimAnalysis(params: SimAnalysisParams): Promise<string | null> {
  ...
  const prompt = `Bạn là chuyên gia phong thủy Á Đông. Hãy phân tích và luận giải báo cáo phong thủy SIM điện thoại bằng tiếng Việt theo phong cách chuyên nghiệp, tích cực.
